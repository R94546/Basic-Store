...
class _POSScreenState extends State<POSScreen> {
  ...
  Future<void> _showBindBarcodeDialog(String code) async {
    ...
    // Shtrix tovarga umumiy biriktirildi. Variantli bo'lsa — savatga
...
class _BindBarcodeDialogState extends State<_BindBarcodeDialog> {
  ...
  /// Shtrixni tovarga UMUMIY biriktiramiz (variantli bo'lsa ham — har
  /// variantga emas). Variantli tovar skan qilinganda variantlar ochiladi.
  ...
  Future<void> _saveNew() async {
    ...
    try {
      final id = await pp.addProduct(Product(
        ...
        price: sell,
        quantity: qty,
        barcode: widget.barcode, // skanerlangan shtrix biriktiriladi
        hasVariants: false,
      ));
